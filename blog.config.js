...
const BLOG = {
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Lin BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是Lin的个人BLOG', // 站点描述，被notion中的页面描述覆盖
